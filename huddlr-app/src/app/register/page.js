    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 p-4 text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-md p-8 bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/80 rounded-2xl shadow-2xl relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-1">Get started with Huddlr collaboration</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-zinc-950/60 border border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl text-sm placeholder-zinc-600 outline-none transition-all"
            />
          </div>
        ...
        <p className="mt-8 text-center text-zinc-500 text-xs">
          ...
          <Link href="/login" className="text-indigo-400 hover:text-indigo-300 font-medium transition-all">
            Sign In
          </Link>
        </p>
      </div>
