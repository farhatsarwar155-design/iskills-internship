  ...
  const signUp = async (email, password, role, profileData = {}) => {
    ...
    const { data, error } = await supabase.auth.signUp({
      ...
      const msg = isFetchError
        ? 'Failed to connect to Supabase server. Please check your internet connection or verify VITE_SUPABASE_URL in frontend/.env.'
        : (err.message || 'An unexpected signup error occurred.')
