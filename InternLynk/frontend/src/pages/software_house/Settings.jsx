...
export default function Settings() {
  ...
  useEffect(() => {
    if (profile) {
      ...
      // Metadata or extra profile fields if available
      setDescription(profile.description || profile.about || '')
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      if (profileError) {
        throw new Error(profileError.message || 'Failed to update organization profile.')
      }

      // If email was changed, request Supabase Auth email update
      if (email.trim().toLowerCase() !== user?.email?.toLowerCase()) {
        ...
        if (authError) {
          ...
          toast.success('Confirmation email sent to verify your new email address.')
        }
      }

      toast.success('Organization settings updated successfully!')
    } catch (err) {
      console.error('[SoftwareHouseSettings] Error updating profile:', err)
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      console.error('[SoftwareHouseSettings] Error changing password:', err)
  ...
  const role = profile?.role || 'software_house'
  const pictureUrl = profile?.profile_picture ? getProfilePictureUrl(profile.profile_picture) : null
  const initials = (organizationName || fullName || user?.email || 'SH')[0]?.toUpperCase()
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto pb-16">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700 rounded-2xl p-6 md:p-8 text-white shadow-md">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Organization Profile & Security</h1>
            <p className="mt-1 text-blue-100 text-sm max-w-xl">
              Configure your software house public details, primary contact email, and access credentials.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 bg-white/10 backdrop-blur-sm px-4 py-3 rounded-xl border border-white/15">
            ...
            <div className="text-left">
              <p className="font-semibold text-sm leading-tight text-white">
                {organizationName || fullName || 'Software House'}
              </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 transition-shadow hover:shadow-md">
            <div className="flex items-center gap-3 pb-5 mb-6 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Visible to applicants and universities across the internship platform
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleProfileSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative rounded-lg shadow-sm">
                  ...
                  <input
                    ...
                    placeholder="e.g. Apex Software Technologies"
              ...
              <div>
                ...
                <div className="relative rounded-lg shadow-sm">
                  ...
                  <input
                    ...
                    placeholder="e.g. John Doe (Lead Recruiter / HR Director)"
                    className="block w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-xs font-semibold uppercase tracking-wider text-gray-700 mb-1.5">
                  Official Contact & Notification Email <span className="text-rose-500">*</span>
                </label>
                <div className="relative rounded-lg shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-gray-400">
                ...
                <p className="mt-1.5 text-xs text-gray-400 flex items-center gap-1">
                  ...
                  This email receives candidate submission notifications and internship approvals.
                </p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 transition-shadow hover:shadow-md">
            <div className="flex items-center gap-3 pb-5 mb-6 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Update your company portal login password</p>
              </div>
            </div>
        ...
        {/* ── Right 1 Column: Account Details & Guidelines ── */}
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-between items-center py-1">
                <span className="text-gray-500 text-xs uppercase tracking-wider font-medium">Account Status</span>
              ...
              <div className="flex justify-between items-center py-1">
                <span className="text-gray-500 text-xs uppercase tracking-wider font-medium">Approval Status</span>
              ...
              <div className="pt-2 border-t border-gray-100">
                <span className="text-gray-400 text-xs block mb-1">Company Account ID</span>
          ...
          {/* Hiring Partner Guidelines Card */}
          <div className="bg-gradient-to-b from-indigo-50 via-blue-50 to-indigo-50 rounded-xl p-5 border border-indigo-100 text-gray-700">
            ...
            <p className="text-xs text-gray-600 leading-relaxed space-y-2">
              All posted internships undergo administrative review before being broadcasted to students. Make sure your listings contain transparent requirements, duration, and stipend information to expedite approval.
            </p>
          </div>
        </div>
      </div>
