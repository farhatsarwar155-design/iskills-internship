      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}> 
          ...
          <Route element={<RoleRoute allowed={["software_house"]} />}>
            ...
            <Route path="/software-house/post-internship" element={<Layout><PostInternship /></Layout>} />
            <Route path="/internships/my" element={<Layout><MyInternships /></Layout>} />
            <Route path="/software-house/internships" element={<Layout><MyInternships /></Layout>} />
            <Route path="/applications/manage" element={<Layout><ManageApplications /></Layout>} />
            <Route path="/software-house/applications" element={<Layout><ManageApplications /></Layout>} />
