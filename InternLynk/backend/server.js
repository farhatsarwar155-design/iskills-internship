...
const supabaseUrl = process.env.VITE_SUPABASE_URL || process.env.SUPABASE_URL || 'https://niukjfjbwsdptejegwsf.supabase.co'
const supabaseKey = process.env.VITE_SUPABASE_ANON_KEY || process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5pdWtqZmpid3NkcHRlamVnd3NmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY4OTA2NzgsImV4cCI6MjEwMjQ2NjY3OH0.yL-y9HsRSAG0ZFP4zWNS7gDminnxP3R1OIGxJC2aZ3c'
...
// Configure CORS explicitly for development and production origins
...
// Root route - InternLynk Backend Status
app.get('/', (_req, res) => {
  res.send(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
      ...
      <title>InternLynk Backend</title>
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .badge::before { content: ''; display: inline-block; width: 8px; height: 8px; background: #10b981; border-radius: 50%; }
        ...
        .btn { display: flex; align-items: center; justify-content: space-between; padding: 12px 18px; border-radius: 10px; text-decoration: none; font-size: 14px; font-weight: 500; transition: all 0.2s ease; }
        .btn-primary { background: #0284c7; color: #ffffff; }
        .btn-primary:hover { background: #0369a1; }
        .btn-secondary { background: #334155; color: #cbd5e1; }
        .btn-secondary:hover { background: #475569; color: #ffffff; }
        .meta { margin-top: 24px; padding-top: 18px; border-top: 1px solid #334155; font-size: 12px; color: #64748b; display: flex; justify-content: space-between; }
      </style>
    </head>
    <body>
      <div class="card">
        <div class="badge">Online</div>
        <h1>InternLynk Backend is running</h1>
        <p>The InternLynk API server is active on port 3001 and connected to Supabase.</p>
        <div class="links">
          <a class="btn btn-primary" href="http://localhost:5173" target="_blank">
            <span>Go to InternLynk Frontend</span>
            <span>➜</span>
          </a>
          ...
          <a class="btn btn-secondary" href="/api/diagnostic">
            <span>API Diagnostics (/api/diagnostic)</span>
            <span>GET</span>
          </a>
        </div>
        <div class="meta">
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`InternLynk backend server listening on http://localhost:${PORT}`)
