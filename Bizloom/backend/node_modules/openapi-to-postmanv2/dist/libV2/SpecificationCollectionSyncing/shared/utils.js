...
exports.stripVendorExtensions = stripVendorExtensions;
exports.isRef = isRef;
exports.isEqualAfterIgnoringVendorExtensions = isEqualAfterIgnoringVendorExtensions;
exports.deepMergeWithVendorExtensions = deepMergeWithVendorExtensions;
exports.protectBarePostmanVariables = protectBarePostmanVariables;
exports.restoreBarePostmanVariables = restoreBarePostmanVariables;
 ...
 */
function isRef(obj) {
    return Boolean(obj) && typeof obj === 'object' && obj !== null && Object.hasOwn(obj, '$ref');
}
/**
 ...
 */
function isEqualAfterIgnoringVendorExtensions(firstFragment, secondFragment) {
    return lodash_1.default.isEqual(stripVendorExtensions(firstFragment), stripVendorExtensions(secondFragment));
}
/**
 ...
 */
function deepMergeWithVendorExtensions(latest, current) {
    ...
    const latestObj = latest, currentObj = current, result = { ...latestObj };
    ...
    const hasCurrentDefault = Object.hasOwn(currentObj, 'default'), hasLatestDefault = Object.hasOwn(latestObj, 'default');
 ...
 */
function protectBarePostmanVariables(raw) {
 ...
 */
function restoreBarePostmanVariables(raw) {
